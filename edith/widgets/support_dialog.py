...
"""The three ways to say Edith is worth keeping around.

Edith collects nothing, which also means it reports nothing back: there is no
...
REPO_URL = "https://github.com/mkay/edith"
...
LIKE_URL = "https://singular.de/apps/feedback/?edith"
...
class SupportDialog(Adw.AlertDialog):
    ...
    def __init__(self, parent=None):
        super().__init__(
            # Translators: title of the "Support Edith" dialog.
        ...
        box.append(self._way(
            ...
            note=_("Entirely optional. Edith is and stays free either way."),
            url=KOFI_URL,
        ))
